...
**/
add_action( 'init', 'vcex_image_swap_shortcode_vc_map' );
		...
		vc_map( array(
			...
			'params'				=> array(
				...
				array(
					...
					'value'			=> '9999',
					'description'	=> __( 'Enter a width in pixels.Images must be the same size for the swap to work correctly.', 'wpex' ),
				...
				array(
					...
					'value'			=> '4px',
					'description'	=> __( 'Enter a custom border radius for your images. Use 50% for rounded images.', 'wpex' ),
						'group'			=> __( 'Image Settings', 'wpex' ),
				),
				array(
					'type'			=> 'dropdown',
				...
				array(
					...
					'param_name'	=> 'link',
					'description'	=> __('Enter a custom link for your image swap wrapper.', 'wpex'),
					'group'			=> __( 'Link', 'wpex' ),
				),
				array(
					'type'			=> 'textfield',
					...
					'description'	=> __('Enter your link title.', 'wpex'),
					'group'			=> __( 'Link', 'wpex' ),
				),
				array(
					'type'			=> 'dropdown',
				...
				array(
					...
					'description'	=> __('Select to enable the tooltip on your link.', 'wpex'),
					'value'			=> array(
						__( 'No', 'wpex' )	=> 'no',
						__( 'Yes', 'wpex' )	=> 'yes'
					),
