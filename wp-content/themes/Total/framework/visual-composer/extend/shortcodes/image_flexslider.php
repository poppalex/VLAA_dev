...
if( !function_exists( 'vcex_image_flexslider_shortcode' ) ) {
	...
	function vcex_image_flexslider_shortcode($atts) {
		...
		if( $attachments ) :
			...
			<div class="vcex-flexslider-wrap clr vcex-img-flexslider"<?php echo $unique_id; ?>>
				<div class="vcex-flexslider flexslider" <?php echo $flexslider_data; ?>><ul class="slides <?php echo $lightbox_class; ?>">
					<?php
					...
					foreach ( $attachments as $attachment ) :
						...
						<li class="vcex-flexslider-slide slide <?php echo $img_rendering; ?>" <?php echo $data_thumb; ?>>
							<div class="vcex-flexslider-entry-media">
								...
								// Lightbox links
								if ( 'lightbox' == $thumbnail_link ) { ?>
									<a href="<?php echo $attachment_img_url; ?>" title="<?php echo $attachment_caption; ?>" class="vcex-flexslider-entry-img">
								...
								if ( 'true' == $caption && $attachment_caption ) { ?>
									<div class="vcex-flexslider-entry-title"><?php echo $attachment_caption; ?></div>
								<?php } ?>
							</div>
						</li>
					<?php endforeach; ?>
...
**/
add_action( 'init', 'vcex_image_flexslider_shortcode_vc_map' );
