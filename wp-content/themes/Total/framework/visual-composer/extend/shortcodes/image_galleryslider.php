	...
	function vcex_image_galleryslider_shortcode($atts) {
		...
		if( $attachments ) :
			...
			<div class="vcex-flexslider-wrap clr vcex-img-galleryslider <?php echo $img_rendering; ?>" <?php echo $unique_id; ?>>
				<div class="vcex-galleryslider flexslider" <?php echo $flexslider_data; ?>>
					<ul class="slides">
						<?php
							...
							<li class="vcex-galleryslider-slide slide" data-thumb="<?php echo $img_thumb; ?>">
								<div class="vcex-galleryslider-entry-media">
									...
									if ( $thumbnail_link == 'lightbox' ) { ?>
										<a href="<?php echo $attachment_img_url; ?>" title="<?php echo $attachment_alt; ?>" class="vcex-galleryslider-entry-img vcex-lightbox">';
...
**/
add_action( 'init', 'vcex_image_galleryslider_shortcode_vc_map' );
		...
		vc_map( array(
			...
			"params"				=> array(
				...
				array(
					...
					"description"	=> __( "Select your gallery images.", 'wpex' ),
