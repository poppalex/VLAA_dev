 ...
 *
 * Based on Pippins tutorial : http://pippinsplugins.com/adding-custom-meta-fields-to-taxonomies/
 *
 * @package WordPress
 * @subpackage Total
 * @since Total 1.0
...
function extra_category_fields( $tag ) {    //check for existing featured ID
	...
	<?php
	// Excerpt length
	$excerpt_length = isset ( $term_meta['wpex_term_excerpt_length'] ) ? $term_meta['wpex_term_excerpt_length'] : wpex_option( 'blog_excerpt_length', '40' ); ?>
	<tr class="form-field">
	...
	<?php
	// Posts Per Page
	$posts_per_page = isset ( $term_meta['wpex_term_posts_per_page'] ) ? $term_meta['wpex_term_posts_per_page'] : get_option( 'posts_per_page' ); ?>
	<tr class="form-field">
	...
	if ( isset ( $term_meta['wpex_term_image_width'] ) ){
		...
		$wpex_term_image_width = wpex_option( 'blog_entry_image_width', '9999' );
	} ?>
	<tr class="form-field">
	...
	if ( isset ( $term_meta['wpex_term_image_height'] ) ){
		...
		$wpex_term_image_height = wpex_option( 'blog_entry_image_height', '9999' );
	} ?>
	<tr class="form-field">
